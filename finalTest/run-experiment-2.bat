...
@REM @REM: 初始分配:zipfr
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 1 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 2 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 4 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 5 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 6 nopassive noactive noexpel 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 7 nopassive noactive noexpel 100

@REM: 驱逐策略：period的选择.zipf和zipfr单独测试
@REM: zipf
...
@REM: zipfr
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 1 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 2 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 4 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 5 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 6 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 7 100
@REM: 驱逐策略 LLU: 3个，保证的是，llu驱逐个数与lifetime驱逐个数基本相同；period选3
...
@REM: LLU在zipf/zipfr下的表现: 使用llu4进行下面的实验
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipf 3 load 10 calculate 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 llu 8 100
...
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipf 3 load 10 calculate 3 curve 3 100
@REM: zipfr
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 noactive llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 noactive llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 calculate 3 llu 8 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 noactive curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 noactive curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 calculate 3 curve 3 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 3 100
...
@REM @REM:zipfr
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive noactive llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 noactive llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive random 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 random 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive noactive curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 noactive curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive random 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 random 3 curve 3 100
...
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipf 3 load 10 calculate 3 llu 8 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipf 3 random 10 random 3 curve 3 100
...
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipf 3 load 10 calculate 3 curve 3 100
@REM:zipfr
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 random 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 calculate 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 random 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 random 3 llu 8 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 llu 8 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 random 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 calculate 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 random 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 popularity 10 random 3 curve 3 100
@REM @REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 3 100
...
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive calculate 3 llu 8 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 nopassive calculate 3 curve 3 100
@REM: zipfr
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 calculate 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 load 10 calculate 3 curve 3 100
@REM python d:/Languages/PythonSpace/AnalysisSanning/finalTest/RunReplica_zipf.py zipfr 3 random 10 calculate 3 llu 8 100
